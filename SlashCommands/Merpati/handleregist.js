...
module.exports = {
    name: "handleregist",
    description: "Menampilkan Panel Register Indoland",
    /**
     *
     * @param {Client} client
    ...
    run: async (client, interaction, args) => {
        ...
        //.setAuthor({ name:"Indoland Roleplay", iconURL:client.config.ICON_URL })
        //.setColor("GOLD")
        //.setTitle("User Control Panel Indoland Roleplay")
        //.setDescription("Halo Player!!, Selamat datang di Indoland Roleplay, disini adalah tempat untuk mengatur User Control Panel anda Seperti Mendaftar, dll")
